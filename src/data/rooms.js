...
export const roomAmenities = {
  // Basic amenities
  WIFI: { id: 'wifi', name: 'Безплатен Wi-Fi', nameEn: 'Free Wi-Fi', icon: '📶' },
  ...
  // Bathroom amenities
  FULL_BATHROOM: { id: 'full_bathroom', name: 'Баня с пълно оборудване(черен обков, сешоар, биде)', nameEn: 'Fully equipped bathroom (black fixtures, hairdryer, bidet)', icon: '🛁' },
  SHOWER: { id: 'shower', name: 'Душ', nameEn: 'Bathroom with shower', icon: '🚿' },
  BIDET: { id: 'bidet', name: 'Биде', nameEn: 'Bidet', icon: '🚽' },
  HAIRDRYER: { id: 'hairdryer', name: 'Сешоар', nameEn: 'Hairdryer', icon: '💨' },
  
  // Room features
  BALCONY: { id: 'balcony', name: 'Балкон с гледка и ратанов комплект', nameEn: 'Balcony with a view and rattan set', icon: '🏗️' },
  CITY_VIEW: { id: 'city_view', name: 'Градска гледка', nameEn: 'City view', icon: '🏙️' },
  
  // Bed options
  KING_BED: { id: 'king_bed', name: 'Легло King size', nameEn: 'King-size bed', icon: '🛏️' },
  TWIN_BEDS: { id: 'twin_beds', name: 'Две отделни легла', nameEn: 'Two separate beds', icon: '🛏️' },
  
  // Furniture & amenities
  SEATING_AREA: { id: 'seating_area', name: 'Кът за сядане с кожени кресла и диван', nameEn: 'Seating area with leather armchairs and sofa', icon: '🪑' },
  DINING_AREA: { id: 'dining_area', name: 'Отделна трапезарна зона', nameEn: 'Separate dining area', icon: '🍽️' },
  WARDROBE: { id: 'wardrobe', name: 'Гардероб', nameEn: 'Wardrobe', icon: '👔' },
  RATTAN_SET: { id: 'rattan_set', name: 'Ратанов комплект', nameEn: 'Rattan set', icon: '🪴' },
  
  // Special features
  TWO_BEDROOMS: { id: 'two_bedrooms', name: 'Две самостоятелни спални', nameEn: 'Two separate bedrooms', icon: '🏠' },
  TWO_BATHROOMS: { id: 'two_bathrooms', name: 'Две бани с пълно оборудване(душ, тоалетна, мивка, сешоар, биде)', nameEn: 'Two fully equipped bathrooms (shower, toilet, sink, hairdryer, bidet)', icon: '🛁' },
  WORK_SPACE: { id: 'work_space', name: 'Работно пространство', nameEn: 'Work area', icon: '💻' },
  DNEVNA_ZONA: { id: 'dnevna_zona', name: 'Дневна зона с диван и фотьойли', nameEn: 'Living area with sofa and armchairs', icon: '🛋️' },
  PROSTORANA_ZONA: { id: 'prostorana_zona', name: 'Просторна зона за сядане', nameEn: 'Spacious seating area', icon: '🪑' },
  BALKON_MASA: { id: 'balkon_masa', name: 'Балкон с маса и столове', nameEn: 'Balcony with table and chairs', icon: '🍽️' },
  SEATING_SOFA_TABLE: { id: 'seating_sofa_table', name: 'Кът за сядане с диван и маса', nameEn: 'Seating area with sofa and table', icon: '🛋️' }
};
